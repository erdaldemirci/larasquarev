...
use Erdaldemirci\Larasquarev\Filter\FilterContract;
use Erdaldemirci\Larasquarev\Filter\FoursquareFilterManager;
...
class Foursquare
{
    ...
    public function __construct($config)
    {
        ...
        $this->client = new FoursquareClient($config['clientId'], $config['clientSecret'], $config['apiUrl'], $config['version'], $config['intent']);
    }
